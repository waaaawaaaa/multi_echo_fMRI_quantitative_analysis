...
nii_dir = 'F:\毕业设计\proprecess\sub-001\func\arsub-001_task-fingerTapping';
%回波1
...
save('sub-001FT_t2starFIT','t2starFIT_4D');

t2starFIT_data_nii=make_nii(t2starFIT_4D);
save_nii(t2starFIT_data_nii,'sub-001_t2starFIT.nii')
%% 
...
save('sub-001FT_T2star_combined','T2star_combined_data');

save('sub-001FT_tSNR_combined','tSNR_combined_data');

save('sub-001FT_TE_combined','TE_combined_data');

save('sub-001FT_t2starFIT_combined','t2starFIT_combined_data');
...
save_nii(T2star_combined_data_nii,'sub-001_T2star_combined.nii')

tSNR_combined_data_nii=make_nii(tSNR_combined_data);
save_nii(tSNR_combined_data_nii,'sub-001_tSNR_combined.nii')

TE_combined_data_nii = make_nii(TE_combined_data);
save_nii(TE_combined_data_nii,'sub-001_TE_combined.nii')

t2starFIT_combined_data_nii=make_nii(t2starFIT_combined_data);
save_nii(t2starFIT_combined_data_nii,'sub-001_t2starFIT_combined.nii')
