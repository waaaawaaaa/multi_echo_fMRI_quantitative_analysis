...
def reset_summary_img(data_dir, metrics, fig):  # 画T值
    ...
    data = []
    ts_names = ['Echo 2', 'TE-combined', 'T2*FIT', 'T2*RELAX']
    ts_colnames = ['echo2', 'TEcombined', 'T2*FIT', 't2*relax']
...
if __name__ == '__main__':
    ...
    # title = ["PSC", "T-value(a.u.)", "Functional contrast", "Temporal contrast-to-noise ratio(a.u.)"]
    title = ["信号变化百分比", "T检验值(a.u.)", "功能对比度", "时间对比度噪声(a.u.)"]
    ...
    for i in range(0,len(metrics)):
        ...
        data_dir = 'F:/rt-me-fMRI/result_44'
